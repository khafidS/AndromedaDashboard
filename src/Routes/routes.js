...
//News Analytics
import NewsAnalytics from "../Pages/News Analytics/News-Analytics";
...
const authProtectedRoutes = [
  ...
  { path: "/analytical-dashboard", component: <UserProfile /> },

  //News Analytics
  { path: "/news-analytics", component: <NewsAnalytics /> },
  ...
  { path: "/identity-access-management", component: <IAM /> },
